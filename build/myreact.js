...
var TodoApp3 = React.createClass({
  ...
  componentWillMount: function () {
    ...
    var tokenGenerator = new FirebaseTokenGenerator("AIzaSyA4AnOgZCduvkGz_RSPadGqN8IzX9DSN1g");
...
ReactDOM.render(React.createElement(TodoApp3, { fire_url: 'https://test-34e8c.firebaseio.com/comments/' }), document.getElementById('content'));